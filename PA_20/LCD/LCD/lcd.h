 ...
 */
#define LCD_FMC_NEX         4              /* 使用FMC_NE4接LCD_CS,取值范围只能是: 1~4 */
#define LCD_FMC_AX          10             /* 使用FMC_A10接LCD_RS,取值范围是: 0 ~ 25 */
 ...
 * 战舰F103开发板使用FMC_NE4连接LCD_CS, FMC_A10连接LCD_RS ,16位数据线,计算方法如下:
 * 首先FMC_NE4的基地址为: 0X6C00 0000;     NEx的基址为(x=1/2/3/4): 0X6000 0000 + (0X400 0000 * (x - 1))
 * FMC_A10对应地址值: 2^10 * 2 = 0X800;    FMC_Ay对应的地址为(y = 0 ~ 25): 2^y * 2
 *
